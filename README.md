...
Sou um profissional focado na **sustentação, automação e arquitetura de sistemas**. Minha base técnica vem de redes e datacenter físico (On-Premise), o que me permite projetar soluções em Cloud com visão real de hardware e estabilidade.

Meu foco não é apenas "subir serviços", mas garantir a **confiabilidade (Reliability)** e a **observabilidade** da operação.

---

### 🚀 Sobre Mim (About Me)

- 🔭 Atualmente focado em **Hybrid Cloud Architectures** e **Site Reliability Engineering (SRE)**.
- 🛠️ Utilizo **Go** e **Python** para criar **ferramentas de automação**, agentes de backup e scripts de infraestrutura.
- 🏢 Tenho experiência liderando operações de **NOC** e sustentação de redes críticas.
- ⚡ **Abordagem:** Transformar tarefas manuais e repetitivas em processos automatizados e resilientes.
...
<div align="left">
  <a href="https://www.linkedin.com/in/edimilson-devops" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank" />
  </a>
  <a href="mailto:blusylake@gmail.com">
